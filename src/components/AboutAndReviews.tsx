...
import { Award, Compass, Heart, Share2, Star, Mail, MapPin, Sparkles, Gift, Play, Pause, Volume2, VolumeX, MessageCircle, Zap, QrCode, Smartphone, ArrowRight, RefreshCw, Check } from "lucide-react";
